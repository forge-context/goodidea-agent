...
const copies: Record<Locale, Copy> = {
  en: {
    ...
    viewGithub: "View Demo source",
    demoNote: "No sign-up. Fixed data.",
    githubNote: "Demo source. Runs locally.",
  ...
  ja: {
    ...
    github: "GitHub",
    tryDemo: "固定 Demo を試す",
    viewGithub: "Demo のソースを見る",
    demoNote: "登録不要。固定データ。",
    githubNote: "Demo のソースを公開。手元で動きます。",
  ...
  "zh-CN": {
    ...
    github: "GitHub",
    tryDemo: "体验固定 Demo",
    viewGithub: "查看 Demo 源码",
    demoNote: "不需要注册，固定数据。",
    githubNote: "Demo 源码公开，可在本地运行。",
