...
const copies: Record<Locale, Copy> = {
  en: {
    ...
    howItems: [
      { number: "01", title: "Ground the idea", text: "Search only what is needed for the next product decision." },
      ...
      { number: "03", title: "Freeze the boundary", text: "Create a coding handoff only after the exact MVP proposal is approved." },
    ],
  ...
  ja: {
    ...
    howItems: [
      { number: "01", title: "アイデアを根拠へつなぐ", text: "次の Product 判断に必要な範囲だけを調べます。" },
      { number: "02", title: "不確実性を一つ減らす", text: "質問の理由を説明し、あなたの答えを待ちます。ご自身の制約として話したことは記憶され、二度言う必要はありません。" },
      { number: "03", title: "境界を固定する", text: "その MVP 提案を人が承認した後だけ、Coding Handoff を作ります。" },
    ],
    sandboxCta: "先に動かす",
  ...
  "zh-CN": {
    ...
    howItems: [
      { number: "01", title: "用证据落地想法", text: "只调查下一个产品决定真正需要的内容。" },
      { number: "02", title: "一次减少一个未知", text: "解释一个问题为什么重要，然后停下来等你决定。你说过的条件会被记住，不用说第二遍。" },
      { number: "03", title: "固定 MVP 边界", text: "用户批准眼前这份提案后，才生成 Coding Agent 交接包。" },
    ],
    sandboxCta: "先跑一段验证",
    sandboxLabel: "沙箱运行",
